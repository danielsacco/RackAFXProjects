...
inline bool PluginCore::isStereoOutput(ProcessFrameInfo& processFrameInfo)
{
	return processFrameInfo.channelIOConfig.outputChannelFormat == kCFStereo;
}

inline bool PluginCore::isStereoInput(ProcessFrameInfo& processFrameInfo)
{
	return processFrameInfo.channelIOConfig.inputChannelFormat == kCFStereo;
}

inline bool PluginCore::isMonoOutput(ProcessFrameInfo& processFrameInfo)
{
	return processFrameInfo.channelIOConfig.outputChannelFormat == kCFMono;
}

inline bool PluginCore::isMonoInput(ProcessFrameInfo& processFrameInfo)
{
...
bool PluginCore::initPluginPresets()
{
  ...
  // --- Preset: Bajo Menta
	preset = new PresetInfo(index++, "Bajo Menta");
	initPresetParameters(preset->presetParameters);
	setPresetParameter(preset->presetParameters, controlID::threshold_dB, -21.399998);
	setPresetParameter(preset->presetParameters, controlID::kneeWidth_dB, 5.000000);
	setPresetParameter(preset->presetParameters, controlID::ratio, 2.000000);
	setPresetParameter(preset->presetParameters, controlID::attackTime_mSec, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::releaseTime_mSec, 45.550007);
	setPresetParameter(preset->presetParameters, controlID::outputGain_dB, 3.400000);
	setPresetParameter(preset->presetParameters, controlID::hardLimitGate, -0.000000);
	setPresetParameter(preset->presetParameters, controlID::softKnee, -0.000000);
	addPreset(preset);

	// --- Preset: Master Pollo Poulet
	preset = new PresetInfo(index++, "Master Pollo Poulet");
	initPresetParameters(preset->presetParameters);
	setPresetParameter(preset->presetParameters, controlID::threshold_dB, -2.599998);
	setPresetParameter(preset->presetParameters, controlID::kneeWidth_dB, 5.000000);
	setPresetParameter(preset->presetParameters, controlID::ratio, 4.135000);
	setPresetParameter(preset->presetParameters, controlID::attackTime_mSec, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::releaseTime_mSec, 10.900004);
	setPresetParameter(preset->presetParameters, controlID::outputGain_dB, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::hardLimitGate, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::softKnee, -0.000000);
	addPreset(preset);
